...
* **`角色`**:
    ...
    - **`企业管理员`**: 用户在注册企业通过审核成功后自动成为该企业管理员,企业管理员可以指定他人成为企业管理员,管理员可以购买应用,管理普通用户的应用使用权限。企业管理员登录应用可以切换应用管理员userid和自身userid身份
    - **`普通用户`**: 用户在企业内有两种角色：企业管理员和普通用户。管理员可以购买应用，管理普通用户的应用使用权限。普通用户只能查看、使用企业应用。无法配置企业信息
